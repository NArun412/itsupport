<?php
// Settings file for HESK 3.4.1

// ==> GENERAL

// --> General settings
$hesk_settings['site_title']='IT Support';
$hesk_settings['site_url']='http://itsupport.mahathiinfotech.com';
$hesk_settings['hesk_title']='IT Support';
$hesk_settings['hesk_url']='http://itsupport.mahathiinfotech.com';
...
// --> Help desk settings
$hesk_settings['admin_dir']='itsupport';
...
$hesk_settings['issue_category']=1;
...
$hesk_settings['select_issue_type']=0;
...
$hesk_settings['secimg_sum']='Z1WR3B39SX';
...
$hesk_settings['question_ask']='Which number is lower <b>9</b> or <b>10</b>:';
...
$hesk_settings['url_key']='Mu_CAj0Za9Bz6SEsyP_53.maN';
...
// --> Email sending
$hesk_settings['noreply_mail']='itsupport@mahathiinfotech.com';
$hesk_settings['noreply_name']='IT Support Service Desk';
$hesk_settings['email_formatting']=3;
$hesk_settings['smtp']=1;
$hesk_settings['smtp_host_name']='smtp.office365.com';
$hesk_settings['smtp_host_port']=587;
$hesk_settings['smtp_timeout']=20;
$hesk_settings['smtp_enc']='tls';
$hesk_settings['smtp_noval_cert']=1;
$hesk_settings['smtp_user']='itsupport@mahathiinfotech.com';
$hesk_settings['smtp_password']='C0nn3ct@ZAQ';
...
$hesk_settings['ticket_list']=array('trackid','lastchange','name','subject','owner','replies','due_date');
...
// --> Date & Time
$hesk_settings['timezone']='Asia/Kolkata';
...
#     DO NOT EDIT BELOW     #
#############################
$hesk_settings['hesk_version']='3.4.1';
