            ...
            <div class="contr">
				...
				<div class="row" style="display: flex;">
					<div class="col" style="width: 33.3%;">
						<img src="img/Mahathi_logo.png" style="width:150px">
					</div>
					<div class="col" style="width: 33.3%;">
						<h3 class="article__heading article__heading--form" style="margin: 0;">					
						...
						<!-- <div class="article-heading-tip" style="margin:0px !important;">
